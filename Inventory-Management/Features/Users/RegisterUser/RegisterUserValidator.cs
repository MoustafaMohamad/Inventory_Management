    ...
    public class RegisterUserValidator : AbstractValidator<RegisterUserEndPointRequest>
    {
        public RegisterUserValidator()
        {
            RuleFor(user => user.UserName)
               ...
               .MinimumLength(5).WithErrorCode(ErrorCode.UserNameLength.ToString()).WithMessage("User name min Length should be 5 char ")
               .MaximumLength(15).WithErrorCode(ErrorCode.UserNameLength.ToString()).WithMessage("User name max Length should be 15 char ");
